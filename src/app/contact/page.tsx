...
import FramedImage from "@/components/ui/FramedImage/FramedImage";
  ...
  return (
    <main className={s.main}>
      <section className={s.section}>
        <Container>
          <span className={s.subtitle}>CONTACT US</span>
          <h1 className={s.title}>We will be glad to help you</h1>
