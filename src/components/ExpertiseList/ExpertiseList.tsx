...
const ExpertiseList: React.FC = () => {
    ...
    return  <motion.ul className={s.list} >
    <motion.li ref={ref1} variants={desk} initial='hidden'  animate={inView1 ? "visible" : "hidden"} transition={{duration: 0.5}} className={s.service_card}>
    ...
    <motion.li ref={ref2} variants={desk} initial='hidden'  animate={inView2 ? "visible" : "hidden"} transition={{duration: 0.5}} className={s.service_card}>
      <span className={s.icon}>
        <Icons.IconCorporate />
      </span>
    ...
    <motion.li ref={ref3} variants={desk} initial='hidden'  animate={inView3 ? "visible" : "hidden"} transition={{duration: 0.5}} className={s.service_card}>
      <span className={s.icon}>
        <Icons.IconCapital />
      </span>
