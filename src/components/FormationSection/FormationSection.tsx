        ...
        <Container>
          <ul className={s.services_list}>
            <Transition
              as="li"
              animate="bubble"
              className={s.services_list_item}
            >
              ...
              <p className={s.service_text}>
                With deep local expertise, MCS acts as an exclusive
                representative for international businesses seeking to expand
                into the UAE, GCC, and Africa, ensuring seamless market entry
